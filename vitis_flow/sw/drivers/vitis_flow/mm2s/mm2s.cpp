...
uint32_t MM2S::Initialise(DeviceInterface* pDeviceInterface, const char* cuName)
{
...
uint32_t MM2S::Uninitialise(void)
{
	uint32_t retval = XLNX_OK;
...
uint32_t MM2S::CheckIsInitialised(void)
{
	uint32_t retval = XLNX_OK;
...
uint32_t MM2S::GetCUIndex(uint32_t* pCUIndex)
{
	uint32_t retval = XLNX_OK;
...
uint32_t MM2S::GetCUAddress(uint64_t* pCUAddress)
{
	uint32_t retval = XLNX_OK;
...
uint32_t MM2S::GetReadBufferCUMemTopologyIndex(uint32_t* pMemTopologyIndex)
{
	uint32_t retval = XLNX_OK;
...
uint32_t MM2S::GetWriteBufferCUMemTopologyIndex(uint32_t* pMemTopologyIndex)
{
	uint32_t retval = XLNX_OK;
...
uint32_t MM2S::StartHWKernel(void)
{
	uint32_t retval = XLNX_OK;
	uint32_t value;
	uint32_t mask;
...
uint32_t MM2S::WriteRegWithMask32(uint64_t offset, uint32_t value, uint32_t mask)
{
	uint32_t retval = XLNX_OK;
	uint64_t address;
...
uint32_t MM2S::BlockReadReg32(uint64_t offset, uint32_t* buffer, uint32_t numWords)
{
	uint32_t retval = XLNX_OK;
	uint64_t address;
...
uint32_t MM2S::BlockReadMem32(uint64_t address, uint32_t* buffer, uint32_t numWords)
{
	uint32_t retval = XLNX_OK;
...
uint32_t MM2S::SetupBufferObjects(void)
{
	uint32_t retval = XLNX_OK;
...
uint32_t MM2S::CleanupBufferObjects(void)
{
	uint32_t retval = XLNX_OK;
...
uint32_t MM2S::SetupBufferObjectsFromCardRAM(void)
{
	uint32_t retval = XLNX_OK;
...
uint32_t MM2S::CleanupBufferObjectsFromCardRAM(void)
{
	uint32_t retval = XLNX_OK;
...
void* MM2S::GetReadBufferHostVirtualAddress(void)
{
	return m_readBufferHostVirtualAddress;
}


uint64_t MM2S::GetReadBufferHWAddress(void)
{
...
void* MM2S::GetWriteBufferHostVirtualAddress(void)
{
...
uint64_t MM2S::GetWriteBufferHWAddress(void)
{
